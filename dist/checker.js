...
var Checker = /*#__PURE__*/ (function () {
  function Checker(checkRule, obj, record) {
    ...
    this.success = true;
    this.record =
      record !== null && record !== void 0 ? record : new _record["default"]();
    ...
    },
    {
      ...
      value: function check(checkRule, obj) {
        if ((0, _typeof2["default"])(obj) !== "object") {
          ...
          if (
            (0, _typeof2["default"])(checkRule) === "object" &&
            Object.keys(checkRule).length === 0
          )
            return;
